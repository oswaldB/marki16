...
global.generateRelancesMaster = require("./workflows/generate-relances/00-master");
global.generateSuivisMaster = require("./workflows/generate-suivi/00-master");
...
console.log(
    "✅ Cloud Functions Marki16 chargées (incluant users, sync-contacts, generate-relances, generate-suivi)",
);
