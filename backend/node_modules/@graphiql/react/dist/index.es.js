...
function generateIcon(RawComponent, title) {
  const WithTitle = /* @__PURE__ */ __name$F(/* @__PURE__ */ __name(function IconComponent(props2) {
...
const ButtonGroup = forwardRef((props2, ref) => /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues({}, props2), {
  ref,
  className: `graphiql-button-group ${props2.className || ""}`.trim()
})));
...
const MarkdownContent = forwardRef((_ga, ref) => {
  ...
  return /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues({}, props2), {
    ref,
    className: compose(`graphiql-markdown-${type2}`, onlyShowFirstChild ? " graphiql-markdown-preview" : "", props2.className),
...
var tabs = /* @__PURE__ */ (() => ".graphiql-tabs{display:flex;overflow-y:auto;padding:var(--px-12)}.graphiql-tabs>:not(:first-child){margin-left:var(--px-12)}.graphiql-tab{align-items:stretch;border-radius:var(--border-radius-8);color:hsla(var(--color-neutral),var(--alpha-secondary));display:flex}.graphiql-tab>button.graphiql-tab-close{visibility:hidden}.graphiql-tab.graphiql-tab-active>button.graphiql-tab-close,.graphiql-tab:hover>button.graphiql-tab-close,.graphiql-tab:focus-within>button.graphiql-tab-close{visibility:unset}.graphiql-tab.graphiql-tab-active{background-color:hsla(var(--color-neutral),var(--alpha-background-heavy));color:hsla(var(--color-neutral),1)}button.graphiql-tab-button{padding:var(--px-4) 0 var(--px-4) var(--px-8)}button.graphiql-tab-close{align-items:center;display:flex;padding:var(--px-4) var(--px-8)}button.graphiql-tab-close>svg{height:var(--px-8);width:var(--px-8)}\n")();
...
function ExecutionContextProvider(props2) {
  ...
  const run3 = useCallback(async () => {
    ...
    setResponse("");
    setIsFetching(true);
    const operationName = (_b = (_a = props2.operationName) != null ? _a : queryEditor.operationName) != null ? _b : void 0;
...
function usePrettifyEditors({ caller } = {}) {
  ...
  return useCallback(() => {
    ...
    if (queryEditor) {
      ...
      const prettifiedEditorContent = print(parse$2(editorContent));
...
function useQueryEditor({
  ...
  useEffect(() => {
    ...
    importCodeMirror([import("./comment.es.js").then(function(n2) {
      ...
      return n2.s;
    }), import("./hint.es.js"), import("./lint.es.js"), import("./info.es.js"), import("./jump.es.js"), import("./mode.es.js")]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function getDefaultTabState({
  ...
  try {
    ...
    return {
      activeTabIndex: 0,
      tabs: [createTab({ query: query != null ? query : defaultQuery, variables, headers })]
    };
  }
}
...
function useStoreTabs({
  ...
  return useCallback((currentState) => {
    store(JSON.stringify(currentState, (key, value3) => key === "hash" || key === "response" || !shouldPersistHeaders && key === "headers" ? null : value3));
...
function useVariableEditor({
  ...
  useEffect(() => {
    let isActive = true;
    importCodeMirror([import("./hint.es2.js"), import("./lint.es2.js"), import("./mode.es3.js")]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
      codeMirrorRef.current = CodeMirror;
...
function HeaderEditor(_ka) {
  ...
  return /* @__PURE__ */ jsx("div", {
    className: `graphiql-editor${isHidden2 ? " hidden" : ""}`,
    ref
  });
}
