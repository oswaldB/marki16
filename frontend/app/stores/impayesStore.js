    ...
    actions: {
        ...
        async getViewData(
            ...
            if (!this.viewsData[viewType].loaded) {
                ...
                this.viewsData[viewType].data = this.filterForView(
                    viewType,
                    search,
                    filtreSequence,
                    sortColumn,
        ...
        filterForView(
            ...
            if (search) {
                ...
                data = data.filter(
                    (i) =>
                        (i.payeur_nom &&
                            i.payeur_nom.toLowerCase().includes(searchLower)) ||
                        (i.nfacture &&
                            i.nfacture.toLowerCase().includes(searchLower)) ||
                        (i.reference &&
                            i.reference.toLowerCase().includes(searchLower)) ||
                        (i.adresse_bien &&
                            i.adresse_bien.toLowerCase().includes(searchLower)),
                );
            }
            ...
            data.sort((a, b) => {
                ...
                switch (sortColumn) {
                    case "reste_a_payer":
                        aVal = a.reste_a_payer;
                        bVal = b.reste_a_payer;
                        break;
                    case "retard":
                        aVal = a.retard;
                        bVal = b.retard;
        ...
        rowToPlain(r) {
            ...
            const calcRetard = (datePiece) => {
                ...
                const d =
                    datePiece instanceof Date ? datePiece : new Date(datePiece);
            ...
            return {
                ...
                retard: calcRetard(r.get("date_echeance")),
