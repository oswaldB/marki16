            ...
            var EventEmitter = (
              ...
              (function() {
                ...
                EventEmitter2.prototype.emitReduce = function(type, source) {
                  ...
                  if (!this.hold && eventHandlers) {
                    eventHandlers.forEach(function(handler) {
                      var result = handler.apply(void 0, __spreadArray2([source], args));
...
var optionsMixin = {
  data: function() {
    ...
    var options = __assign2(__assign2({}, this.options), { initialEditType: this.initialEditType, initialValue: this.initialValue, height: this.height, previewStyle: this.previewStyle, events: eventOptions });
...
var script$1 = {
  ...
  mounted: function() {
    var options = __assign2(__assign2({}, this.computedOptions), { el: this.$refs.toastuiEditor });
...
var __vue_component__$1 = normalizeComponent({ render: __vue_render__$1, staticRenderFns: __vue_staticRenderFns__$1 }, __vue_inject_styles__$1, __vue_script__$1, __vue_scope_id__$1, __vue_is_functional_template__$1, __vue_module_identifier__$1, false, void 0, void 0, void 0);
var script = {
  ...
  mounted: function() {
    var options = __assign2(__assign2({}, this.computedOptions), { el: this.$refs.toastuiEditorViewer });
    this.editor = new import_toastui_editor_viewer.default(options);
  },
  methods: {
    getRootElement: function() {
...
var __vue_component__ = normalizeComponent({ render: __vue_render__, staticRenderFns: __vue_staticRenderFns__ }, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__, __vue_module_identifier__, false, void 0, void 0, void 0);
export {
  __vue_component__$1 as Editor,
  __vue_component__ as Viewer
};
//# sourceMappingURL=@toast-ui_vue-editor.js.map
